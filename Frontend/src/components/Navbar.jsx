...
function Navbar() {
  ...
  return (
    <>
      <div
        className={`max-w-screen-2xl container mx-auto md:px-20  px-4 fixed right-0 top-0 left-0 shadow-slate-300 z-50 dark:bg-slate-900 dark:text-white ${
          sticky
      ...
      >
        <div className="navbar ">
          ...
          <div className="navbar-end space-x-3">
            ...
            <div className="">
              <a
                className="bg-black text-white px-2 py-2 rounded-md hover:bg-slate-700 duration-300 cursor-pointer"
                onClick={() =>
